...
import { MessagesSquare, ChartColumnBig, ScanQrCode, Trash, Copy, RotateCcw } from 'lucide-react';
      ...
      <Card className="flex flex-col overflow-y-auto relative rounded-2xl bg-white h-full">
        <CardHeader>
          <CardTitle className='flex justify-center items-center gap-1 '>
            You are host of: <span className="bg-yellow-300 text-black rotate-2">{roomName}</span>
          ...
          <CardDescription className='grid grid-cols-2 w-full gap-1'>
            <Popover>
              ...
              <PopoverContent className="w-48 p-2 backdrop-blur-sm">
                <Button onClick={handleGroupQuestions} className='justify-between w-full mb-2 bg-blue-500 text-white hover:bg-blue-700 font-bold flex'><MessagesSquare /> Group questions</Button>
                <Button onClick={handleClearQuestion} className='justify-between w-full mb-2 bg-yellow-500 text-white hover:bg-yellow-700 font-bold flex'><Trash /> Clear questions</Button>
                <Button onClick={handleRestartRound} className='justify-between w-full mb-2 bg-red-500 text-white hover:bg-red-700 font-bold flex'><RotateCcw /> Restart Q&A</Button>
              </PopoverContent>
            </Popover>
            {/* Poll button */}
            <Popover>
              ...
              <PopoverContent className="w-48 p-2 backdrop-blur-sm">
                <Button className='text-center w-full mb-2 bg-blue-500 text-white hover:bg-blue-700 font-bold flex'><ChartColumnBig /> Create polls</Button>
              </PopoverContent>
            </Popover>
